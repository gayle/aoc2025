...
def test_right_rotation(): 
	assert 12 == Day1Part1.rotate_dial(5, "R7")

def test_right_rotation_pass_99(): 
	assert 55 == Day1Part1.rotate_dial(95, "R60")

def test_right_rotation_start_at_0(): 
	assert 14 == Day1Part1.rotate_dial(0, "R14")

def test_right_rotation_end_at_0(): 
	assert 0 == Day1Part1.rotate_dial(52, "R48")

def test_right_rotation_large_number(): 
	assert 0 == Day1Part1.rotate_dial(50, "R450")

def test_left_rotation(): 
	assert 52 == Day1Part1.rotate_dial(82, "L30")

def test_left_rotation_pass_0(): 
	assert 82 == Day1Part1.rotate_dial(50, "L68")

def test_left_rotation_start_at_0(): 
	assert 95 == Day1Part1.rotate_dial(0, "L5")

def test_left_rotation_end_at_0(): 
	assert 0 == Day1Part1.rotate_dial(55, "L55")

def test_left_rotation_large_number(): 
	assert 0 == Day1Part1.rotate_dial(50, "L450")

def test_invalid_input_starting_position_negative(): 
	try: 
		Day1Part1.rotate_dial(-1, "R10")
...
def test_invalid_input_letter(): 
	try: 
		Day1Part1.rotate_dial(50, "X10")
		assert False, "Invalid direction; expected 'L' or 'R'"
	except ValueError: 
		pass

def test_count_times_dial_is_at_zero(): 
	test_content = """
	L68
	L30
	R48
	...
	try:
		result = Day1Part1.count_times_dial_is_at_zero(temp_filename)
		assert 3 == result
	finally: 
