...
class Day4Part1:
    ...
    @staticmethod
    def count_of_accessible_rolls(lines):
        return len(Day4Part1.accessible_rolls(lines))
...
if __name__ == "__main__":
    ...
    result = Day4Part1.count_of_accessible_rolls(lines)
