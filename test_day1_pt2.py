...
def test_right_rotation():
    assert (0,12) == Day1Pt2.rotate_dial(5, "R7")

def test_right_rotation_pass_99():
    assert (1,55) == Day1Pt2.rotate_dial(95, "R60")

def test_right_rotation_start_at_0():
    assert (0,14) == Day1Pt2.rotate_dial(0, "R14")

def test_right_rotation_end_at_0():
    assert (1,0) == Day1Pt2.rotate_dial(52, "R48")

def test_right_rotation_large_number():
    assert (10,50) == Day1Pt2.rotate_dial(50, "R1000")

def test_left_rotation():
    assert (0,52) == Day1Pt2.rotate_dial(82, "L30")

def test_left_rotation_pass_0():
    assert (1,82) == Day1Pt2.rotate_dial(50, "L68")

def test_left_rotation_start_at_0():
    assert (0,95) == Day1Pt2.rotate_dial(0, "L5")

def test_left_rotation_end_at_0():
    assert (1,0) == Day1Pt2.rotate_dial(55, "L55")

def test_left_rotation_large_number():
    assert (5,0) == Day1Pt2.rotate_dial(50, "L450")

def test_left_rotation_larger_number():
    assert (10,50) == Day1Pt2.rotate_dial(50, "L1000")

def test_invalid_input_starting_position_negative():
    try:
        Day1Pt2.rotate_dial(-1, "R10")
...
def test_count_times_dial_crosses_zero():
    ...
    try:
        result = Day1Pt2.count_times_dial_crosses_zero(temp_filename)
        assert 6 == result
    finally:
